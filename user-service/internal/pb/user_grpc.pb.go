...
type UserServiceClient interface {
	...
	UpdateUserProfile(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error)
}
...
func (c *userServiceClient) UpdateUserProfile(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	UpdateUserProfile(context.Context, *UpdateRequest) (*UpdateResponse, error)
...
func (UnimplementedUserServiceServer) UpdateUserProfile(context.Context, *UpdateRequest) (*UpdateResponse, error) {
